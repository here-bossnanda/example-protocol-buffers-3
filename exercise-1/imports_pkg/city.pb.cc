...
// source: exercise-1/imports_pkg/city.proto

#include "exercise-1/imports_pkg/city.pb.h"
...
static ::_pb::Metadata file_level_metadata_exercise_2d1_2fimports_5fpkg_2fcity_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_exercise_2d1_2fimports_5fpkg_2fcity_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_exercise_2d1_2fimports_5fpkg_2fcity_2eproto = nullptr;

const uint32_t TableStruct_exercise_2d1_2fimports_5fpkg_2fcity_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_exercise_2d1_2fimports_5fpkg_2fcity_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n!exercise-1/imports_pkg/city.proto\022\004cit"
  "y\"<\n\004City\022\014\n\004name\030\001 \001(\t\022\020\n\010zip_code\030\002 \001("
  "\t\022\024\n\014country_name\030\003 \001(\tb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_exercise_2d1_2fimports_5fpkg_2fcity_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_exercise_2d1_2fimports_5fpkg_2fcity_2eproto = {
    false, false, 111, descriptor_table_protodef_exercise_2d1_2fimports_5fpkg_2fcity_2eproto,
    "exercise-1/imports_pkg/city.proto",
    &descriptor_table_exercise_2d1_2fimports_5fpkg_2fcity_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_exercise_2d1_2fimports_5fpkg_2fcity_2eproto::offsets,
    file_level_metadata_exercise_2d1_2fimports_5fpkg_2fcity_2eproto, file_level_enum_descriptors_exercise_2d1_2fimports_5fpkg_2fcity_2eproto,
    file_level_service_descriptors_exercise_2d1_2fimports_5fpkg_2fcity_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_exercise_2d1_2fimports_5fpkg_2fcity_2eproto_getter() {
  return &descriptor_table_exercise_2d1_2fimports_5fpkg_2fcity_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_exercise_2d1_2fimports_5fpkg_2fcity_2eproto(&descriptor_table_exercise_2d1_2fimports_5fpkg_2fcity_2eproto);
namespace city {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "city.City.name"));
        } else
          goto handle_unusual;
        continue;
      // string zip_code = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "city.City.zip_code"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "city.City.country_name"));
        } else
          goto handle_unusual;
        continue;
      default:
...
::PROTOBUF_NAMESPACE_ID::Metadata City::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_exercise_2d1_2fimports_5fpkg_2fcity_2eproto_getter, &descriptor_table_exercise_2d1_2fimports_5fpkg_2fcity_2eproto_once,
      file_level_metadata_exercise_2d1_2fimports_5fpkg_2fcity_2eproto[0]);
}

// @@protoc_insertion_point(namespace_scope)
}  // namespace city
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::city::City*
Arena::CreateMaybeMessage< ::city::City >(Arena* arena) {
